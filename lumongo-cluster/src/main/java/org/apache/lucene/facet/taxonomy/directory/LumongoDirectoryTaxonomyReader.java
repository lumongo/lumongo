 ...
 * @lucene.experimental
 */
public class LumongoDirectoryTaxonomyReader implements TaxonomyReader {
  ...
  private LumongoDirectoryTaxonomyWriter lumongoDirectoryTaxonomyWriter;
  ...
  // with itself.
  public synchronized boolean refresh(boolean realTime) throws IOException, InconsistentTaxonomyException {
    ensureOpen();
    /*
    ...
    // this is not possible in Lumongo
    ...
    DirectoryReader newReader = lumongoDirectoryTaxonomyWriter.openReader(realTime);
