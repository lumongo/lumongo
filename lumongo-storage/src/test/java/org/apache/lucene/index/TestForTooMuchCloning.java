...
public class TestForTooMuchCloning extends LumongoTestCase {
	...
	public void test() throws Exception {
		...
		final RandomIndexWriter w = new RandomIndexWriter(random(), dir, newIndexWriterConfig(TEST_VERSION_CURRENT, new MockAnalyzer(random()))
						.setMaxBufferedDocs(2).setMergePolicy(tmp));
