...
public class Mapper <T> {
	...
	public StoreRequest toStoreRequest(T object) throws IllegalArgumentException, IllegalAccessException {
		if (settings == null) {
			throw new RuntimeException("No Settings annonation for class <" + clazz.getSimpleName() + ">");
		}
	...
	public StoreRequest toStoreRequest(String index, T object) throws IllegalArgumentException, IllegalAccessException {
	...
	public ResultDocument toResultDocument(T object) throws IllegalArgumentException, IllegalAccessException {
